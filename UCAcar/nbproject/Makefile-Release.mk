...
${OBJECTDIR}/_ext/99c1f9e6/main.o: ../CompartirCoche/main.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/99c1f9e6/main.o ../CompartirCoche/main.c
...
${OBJECTDIR}/Usuarios.o: Usuarios.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Usuarios.o Usuarios.c
