...
void modificaAdmin(Usuarios *lista,int *elementos){
    ...
    pos=buscar_usuario(id,lista,*elementos);//pregunta
    opcion=leer_numero("Que campo desea modificar?\n1-Nombre\n2-Localidad\n3-Nickname\n4-Contraseña\n5-Estado");
    do{
    switch(opcion){
        case 1:lista[pos].Nomb_usuario=leer_campo(TAM_NOM_USER,"Modifique el NOMBRE del usuario:\n");
            break;
        case 2:lista[pos].Localidad=leer_campo(TAM_LOC_USER,"Modifique la LOCALIDAD del usuario:\n");
            break;
        case 3:lista[pos].User=leer_campo(TAM_USE_USER,"Modifique el NICKNAME del usuario:\n");
            break;
        case 4:lista[pos].Login=leer_campo(TAM_LOG_USER,"Modifique la CONTRASEÑA del usuario:\n");
            break;
        case 5:lista[pos].Estado=leer_campo(TAM_EST_USER,"Modifique el ESTADO del usuario:\n");
            break;    
        }
